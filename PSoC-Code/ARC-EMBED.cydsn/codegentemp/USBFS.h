...
#define USBFS_INTR_LVL_SEL                     (0x000A8028u)
...
typedef struct
{
    uint32 epData[USBFS_EP0_DR_MAPPED_REG_CNT];
} USBFS_ep0_data_struct;

/* Number of SIE endpoint registers group. */
#define USBFS_SIE_EP_REG_SIZE   (USBFS_cy_m0s8_usb__SIE_EP1_CR0 - \
                                            USBFS_cy_m0s8_usb__SIE_EP1_CNT0)

/* Size of gap between SIE endpoint registers groups. */
#define USBFS_SIE_GAP_CNT        (((USBFS_cy_m0s8_usb__SIE_EP2_CNT0 - \
                                             (USBFS_cy_m0s8_usb__SIE_EP1_CNT0 + \
                                              USBFS_SIE_EP_REG_SIZE)) / sizeof(reg32)) - 1u)
...
typedef struct
{
    ...
    uint32 epCnt1;
    uint32 epCr0;
    uint32 gap[USBFS_SIE_GAP_CNT];
} USBFS_sie_ep_struct;

/* Number of ARB endpoint registers group. */
#define USBFS_ARB_EP_REG_SIZE    (USBFS_cy_m0s8_usb__ARB_RW1_DR - \
                                             USBFS_cy_m0s8_usb__ARB_EP1_CFG)

/* Size of gap between ARB endpoint registers groups. */
#define USBFS_ARB_GAP_CNT        (((USBFS_cy_m0s8_usb__ARB_EP2_CFG - \
                                             (USBFS_cy_m0s8_usb__ARB_EP1_CFG + \
                                              USBFS_ARB_EP_REG_SIZE)) / sizeof(reg32)) - 1u)
...
typedef struct
{
    ...
    uint32 rwRaMsb;
    uint32 rwDr;
    uint32 gap[USBFS_ARB_GAP_CNT];
} USBFS_arb_ep_struct;

#if (CY_PSOC4)
    /* Number of ARB endpoint registers group (16-bits access). */
    #define USBFS_ARB_EP_REG16_SIZE      (USBFS_cy_m0s8_usb__ARB_RW1_DR16 - \
                                                     USBFS_cy_m0s8_usb__ARB_RW1_WA16)

    /* Size of gap between ARB endpoint registers groups (16-bits access). */
    #define USBFS_ARB_EP_REG16_GAP_CNT   (((USBFS_cy_m0s8_usb__ARB_RW2_WA16 - \
                                                     (USBFS_cy_m0s8_usb__ARB_RW1_WA16 + \
                                                      USBFS_ARB_EP_REG16_SIZE)) / sizeof(reg32)) - 1u)
    ...
    typedef struct
    {
        ...
        uint32 reserved1;
        uint32 rwDr16;
        uint32 gap[USBFS_ARB_EP_REG16_GAP_CNT];
...
#define USBFS_ARB_CFG_PTR        ( (reg32 *) USBFS_cy_m0s8_usb__ARB_CFG)
#define USBFS_ARB_CFG_REG        (*(reg32 *) USBFS_cy_m0s8_usb__ARB_CFG)

#define USBFS_ARB_EP1_CFG_PTR    ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP1_CFG)
#define USBFS_ARB_EP1_CFG_REG    (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP1_CFG)
#define USBFS_ARB_EP1_INT_EN_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP1_INT_EN)
#define USBFS_ARB_EP1_INT_EN_REG (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP1_INT_EN)
#define USBFS_ARB_EP1_SR_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP1_SR)
#define USBFS_ARB_EP1_SR_REG     (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP1_SR)
#define USBFS_ARB_EP1_CFG_IND    USBFS_cy_m0s8_usb__ARB_EP1_CFG
#define USBFS_ARB_EP1_INT_EN_IND USBFS_cy_m0s8_usb__ARB_EP1_INT_EN
#define USBFS_ARB_EP1_SR_IND     USBFS_cy_m0s8_usb__ARB_EP1_SR
#define USBFS_ARB_EP_BASE        (*(volatile USBFS_arb_eps_struct CYXDATA *) \
                                            (USBFS_cy_m0s8_usb__ARB_EP1_CFG - sizeof(USBFS_arb_ep_struct)))

#define USBFS_ARB_EP2_CFG_PTR    ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP2_CFG)
#define USBFS_ARB_EP2_CFG_REG    (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP2_CFG)
#define USBFS_ARB_EP2_INT_EN_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP2_INT_EN)
#define USBFS_ARB_EP2_INT_EN_REG (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP2_INT_EN)
#define USBFS_ARB_EP2_SR_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP2_SR)
#define USBFS_ARB_EP2_SR_REG     (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP2_SR)

#define USBFS_ARB_EP3_CFG_PTR    ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP3_CFG)
#define USBFS_ARB_EP3_CFG_REG    (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP3_CFG)
#define USBFS_ARB_EP3_INT_EN_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP3_INT_EN)
#define USBFS_ARB_EP3_INT_EN_REG (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP3_INT_EN)
#define USBFS_ARB_EP3_SR_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP3_SR)
#define USBFS_ARB_EP3_SR_REG     (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP3_SR)

#define USBFS_ARB_EP4_CFG_PTR    ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP4_CFG)
#define USBFS_ARB_EP4_CFG_REG    (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP4_CFG)
#define USBFS_ARB_EP4_INT_EN_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP4_INT_EN)
#define USBFS_ARB_EP4_INT_EN_REG (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP4_INT_EN)
#define USBFS_ARB_EP4_SR_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP4_SR)
#define USBFS_ARB_EP4_SR_REG     (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP4_SR)

#define USBFS_ARB_EP5_CFG_PTR    ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP5_CFG)
#define USBFS_ARB_EP5_CFG_REG    (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP5_CFG)
#define USBFS_ARB_EP5_INT_EN_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP5_INT_EN)
#define USBFS_ARB_EP5_INT_EN_REG (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP5_INT_EN)
#define USBFS_ARB_EP5_SR_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP5_SR)
#define USBFS_ARB_EP5_SR_REG     (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP5_SR)

#define USBFS_ARB_EP6_CFG_PTR    ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP6_CFG)
#define USBFS_ARB_EP6_CFG_REG    (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP6_CFG)
#define USBFS_ARB_EP6_INT_EN_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP6_INT_EN)
#define USBFS_ARB_EP6_INT_EN_REG (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP6_INT_EN)
#define USBFS_ARB_EP6_SR_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP6_SR)
#define USBFS_ARB_EP6_SR_REG     (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP6_SR)

#define USBFS_ARB_EP7_CFG_PTR    ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP7_CFG)
#define USBFS_ARB_EP7_CFG_REG    (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP7_CFG)
#define USBFS_ARB_EP7_INT_EN_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP7_INT_EN)
#define USBFS_ARB_EP7_INT_EN_REG (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP7_INT_EN)
#define USBFS_ARB_EP7_SR_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP7_SR)
#define USBFS_ARB_EP7_SR_REG     (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP7_SR)

#define USBFS_ARB_EP8_CFG_PTR    ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP8_CFG)
#define USBFS_ARB_EP8_CFG_REG    (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP8_CFG)
#define USBFS_ARB_EP8_INT_EN_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP8_INT_EN)
#define USBFS_ARB_EP8_INT_EN_REG (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP8_INT_EN)
#define USBFS_ARB_EP8_SR_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_EP8_SR)
#define USBFS_ARB_EP8_SR_REG     (*(reg32 *) USBFS_cy_m0s8_usb__ARB_EP8_SR)

#define USBFS_ARB_INT_EN_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_INT_EN)
#define USBFS_ARB_INT_EN_REG     (*(reg32 *) USBFS_cy_m0s8_usb__ARB_INT_EN)
#define USBFS_ARB_INT_SR_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_INT_SR)
#define USBFS_ARB_INT_SR_REG     (*(reg32 *) USBFS_cy_m0s8_usb__ARB_INT_SR)

#define USBFS_ARB_RW1_DR_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW1_DR)
#define USBFS_ARB_RW1_RA_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW1_RA)

#define USBFS_ARB_RW1_RA_MSB_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW1_RA_MSB)
#define USBFS_ARB_RW1_WA_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW1_WA)
#define USBFS_ARB_RW1_WA_MSB_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW1_WA_MSB)
#define USBFS_ARB_RW1_DR_IND     USBFS_cy_m0s8_usb__ARB_RW1_DR
#define USBFS_ARB_RW1_RA_IND     USBFS_cy_m0s8_usb__ARB_RW1_RA
#define USBFS_ARB_RW1_RA_MSB_IND USBFS_cy_m0s8_usb__ARB_RW1_RA_MSB
#define USBFS_ARB_RW1_WA_IND     USBFS_cy_m0s8_usb__ARB_RW1_WA
#define USBFS_ARB_RW1_WA_MSB_IND USBFS_cy_m0s8_usb__ARB_RW1_WA_MSB

#define USBFS_ARB_RW2_DR_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW2_DR)
#define USBFS_ARB_RW2_RA_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW2_RA)
#define USBFS_ARB_RW2_RA_MSB_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW2_RA_MSB)
#define USBFS_ARB_RW2_WA_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW2_WA)
#define USBFS_ARB_RW2_WA_MSB_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW2_WA_MSB)

#define USBFS_ARB_RW3_DR_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW3_DR)
#define USBFS_ARB_RW3_RA_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW3_RA)
#define USBFS_ARB_RW3_RA_MSB_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW3_RA_MSB)
#define USBFS_ARB_RW3_WA_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW3_WA)
#define USBFS_ARB_RW3_WA_MSB_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW3_WA_MSB)

#define USBFS_ARB_RW4_DR_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW4_DR)
#define USBFS_ARB_RW4_RA_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW4_RA)
#define USBFS_ARB_RW4_RA_MSB_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW4_RA_MSB)
#define USBFS_ARB_RW4_WA_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW4_WA)
#define USBFS_ARB_RW4_WA_MSB_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW4_WA_MSB)

#define USBFS_ARB_RW5_DR_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW5_DR)
#define USBFS_ARB_RW5_RA_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW5_RA)
#define USBFS_ARB_RW5_RA_MSB_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW5_RA_MSB)
#define USBFS_ARB_RW5_WA_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW5_WA)
#define USBFS_ARB_RW5_WA_MSB_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW5_WA_MSB)

#define USBFS_ARB_RW6_DR_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW6_DR)
#define USBFS_ARB_RW6_RA_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW6_RA)
#define USBFS_ARB_RW6_RA_MSB_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW6_RA_MSB)
#define USBFS_ARB_RW6_WA_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW6_WA)
#define USBFS_ARB_RW6_WA_MSB_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW6_WA_MSB)

#define USBFS_ARB_RW7_DR_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW7_DR)
#define USBFS_ARB_RW7_RA_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW7_RA)
#define USBFS_ARB_RW7_RA_MSB_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW7_RA_MSB)
#define USBFS_ARB_RW7_WA_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW7_WA)
#define USBFS_ARB_RW7_WA_MSB_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW7_WA_MSB)

#define USBFS_ARB_RW8_DR_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW8_DR)
#define USBFS_ARB_RW8_RA_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW8_RA)
#define USBFS_ARB_RW8_RA_MSB_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW8_RA_MSB)
#define USBFS_ARB_RW8_WA_PTR     ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW8_WA)
#define USBFS_ARB_RW8_WA_MSB_PTR ( (reg32 *) USBFS_cy_m0s8_usb__ARB_RW8_WA_MSB)

#define USBFS_BUF_SIZE_PTR       ( (reg32 *) USBFS_cy_m0s8_usb__BUF_SIZE)
#define USBFS_BUF_SIZE_REG       (*(reg32 *) USBFS_cy_m0s8_usb__BUF_SIZE)
#define USBFS_BUS_RST_CNT_PTR    ( (reg32 *) USBFS_cy_m0s8_usb__BUS_RST_CNT)
#define USBFS_BUS_RST_CNT_REG    (*(reg32 *) USBFS_cy_m0s8_usb__BUS_RST_CNT)
#define USBFS_CWA_PTR            ( (reg32 *) USBFS_cy_m0s8_usb__CWA)
#define USBFS_CWA_REG            (*(reg32 *) USBFS_cy_m0s8_usb__CWA)
#define USBFS_CWA_MSB_PTR        ( (reg32 *) USBFS_cy_m0s8_usb__CWA_MSB)
#define USBFS_CWA_MSB_REG        (*(reg32 *) USBFS_cy_m0s8_usb__CWA_MSB)
#define USBFS_CR0_PTR            ( (reg32 *) USBFS_cy_m0s8_usb__CR0)
#define USBFS_CR0_REG            (*(reg32 *) USBFS_cy_m0s8_usb__CR0)
#define USBFS_CR1_PTR            ( (reg32 *) USBFS_cy_m0s8_usb__CR1)
#define USBFS_CR1_REG            (*(reg32 *) USBFS_cy_m0s8_usb__CR1)

#define USBFS_DMA_THRES_PTR      ( (reg32 *) USBFS_cy_m0s8_usb__DMA_THRES)
#define USBFS_DMA_THRES_REG      (*(reg32 *) USBFS_cy_m0s8_usb__DMA_THRES)
#define USBFS_DMA_THRES_MSB_PTR  ( (reg32 *) USBFS_cy_m0s8_usb__DMA_THRES_MSB)
#define USBFS_DMA_THRES_MSB_REG  (*(reg32 *) USBFS_cy_m0s8_usb__DMA_THRES_MSB)

#define USBFS_EP_ACTIVE_PTR      ( (reg32 *) USBFS_cy_m0s8_usb__EP_ACTIVE)
#define USBFS_EP_ACTIVE_REG      (*(reg32 *) USBFS_cy_m0s8_usb__EP_ACTIVE)
#define USBFS_EP_TYPE_PTR        ( (reg32 *) USBFS_cy_m0s8_usb__EP_TYPE)
#define USBFS_EP_TYPE_REG        (*(reg32 *) USBFS_cy_m0s8_usb__EP_TYPE)

#define USBFS_EP0_CNT_PTR        ( (reg32 *) USBFS_cy_m0s8_usb__EP0_CNT)
#define USBFS_EP0_CNT_REG        (*(reg32 *) USBFS_cy_m0s8_usb__EP0_CNT)
#define USBFS_EP0_CR_PTR         ( (reg32 *) USBFS_cy_m0s8_usb__EP0_CR)
#define USBFS_EP0_CR_REG         (*(reg32 *) USBFS_cy_m0s8_usb__EP0_CR)
#define USBFS_EP0_DR0_PTR        ( (reg32 *) USBFS_cy_m0s8_usb__EP0_DR0)
#define USBFS_EP0_DR0_REG        (*(reg32 *) USBFS_cy_m0s8_usb__EP0_DR0)
#define USBFS_EP0_DR1_PTR        ( (reg32 *) USBFS_cy_m0s8_usb__EP0_DR1)
#define USBFS_EP0_DR1_REG        (*(reg32 *) USBFS_cy_m0s8_usb__EP0_DR1)
#define USBFS_EP0_DR2_PTR        ( (reg32 *) USBFS_cy_m0s8_usb__EP0_DR2)
#define USBFS_EP0_DR2_REG        (*(reg32 *) USBFS_cy_m0s8_usb__EP0_DR2)
#define USBFS_EP0_DR3_PTR        ( (reg32 *) USBFS_cy_m0s8_usb__EP0_DR3)
#define USBFS_EP0_DR3_REG        (*(reg32 *) USBFS_cy_m0s8_usb__EP0_DR3)
#define USBFS_EP0_DR4_PTR        ( (reg32 *) USBFS_cy_m0s8_usb__EP0_DR4)
#define USBFS_EP0_DR4_REG        (*(reg32 *) USBFS_cy_m0s8_usb__EP0_DR4)
#define USBFS_EP0_DR5_PTR        ( (reg32 *) USBFS_cy_m0s8_usb__EP0_DR5)
#define USBFS_EP0_DR5_REG        (*(reg32 *) USBFS_cy_m0s8_usb__EP0_DR5)
#define USBFS_EP0_DR6_PTR        ( (reg32 *) USBFS_cy_m0s8_usb__EP0_DR6)
#define USBFS_EP0_DR6_REG        (*(reg32 *) USBFS_cy_m0s8_usb__EP0_DR6)
#define USBFS_EP0_DR7_PTR        ( (reg32 *) USBFS_cy_m0s8_usb__EP0_DR7)
#define USBFS_EP0_DR7_REG        (*(reg32 *) USBFS_cy_m0s8_usb__EP0_DR7)
#define USBFS_EP0_DR0_IND        USBFS_cy_m0s8_usb__EP0_DR0
#define USBFS_EP0_DR_BASE        (*(volatile USBFS_ep0_data_struct CYXDATA *) USBFS_cy_m0s8_usb__EP0_DR0)

#define USBFS_OSCLK_DR0_PTR      ( (reg32 *) USBFS_cy_m0s8_usb__OSCLK_DR0)
#define USBFS_OSCLK_DR0_REG      (*(reg32 *) USBFS_cy_m0s8_usb__OSCLK_DR0)
#define USBFS_OSCLK_DR1_PTR      ( (reg32 *) USBFS_cy_m0s8_usb__OSCLK_DR1)
#define USBFS_OSCLK_DR1_REG      (*(reg32 *) USBFS_cy_m0s8_usb__OSCLK_DR1)

#define USBFS_SIE_EP_INT_EN_PTR  ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP_INT_EN)
#define USBFS_SIE_EP_INT_EN_REG  (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP_INT_EN)
#define USBFS_SIE_EP_INT_SR_PTR  ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP_INT_SR)
#define USBFS_SIE_EP_INT_SR_REG  (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP_INT_SR)

#define USBFS_SIE_EP1_CNT0_PTR   ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP1_CNT0)
#define USBFS_SIE_EP1_CNT0_REG   (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP1_CNT0)
#define USBFS_SIE_EP1_CNT1_PTR   ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP1_CNT1)
#define USBFS_SIE_EP1_CNT1_REG   (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP1_CNT1)
#define USBFS_SIE_EP1_CR0_PTR    ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP1_CR0)
#define USBFS_SIE_EP1_CR0_REG    (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP1_CR0)
#define USBFS_SIE_EP1_CNT1_IND   USBFS_cy_m0s8_usb__SIE_EP1_CNT1
#define USBFS_SIE_EP1_CNT0_IND   USBFS_cy_m0s8_usb__SIE_EP1_CNT0
#define USBFS_SIE_EP1_CR0_IND    USBFS_cy_m0s8_usb__SIE_EP1_CR0
#define USBFS_SIE_EP_BASE        (*(volatile USBFS_sie_eps_struct CYXDATA *) \
                                            (USBFS_cy_m0s8_usb__SIE_EP1_CNT0 - sizeof(USBFS_sie_ep_struct)))

#define USBFS_SIE_EP2_CNT0_PTR   ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP2_CNT0)
#define USBFS_SIE_EP2_CNT0_REG   (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP2_CNT0)
#define USBFS_SIE_EP2_CNT1_PTR   ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP2_CNT1)
#define USBFS_SIE_EP2_CNT1_REG   (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP2_CNT1)
#define USBFS_SIE_EP2_CR0_PTR    ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP2_CR0)
#define USBFS_SIE_EP2_CR0_REG    (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP2_CR0)

#define USBFS_SIE_EP3_CNT0_PTR   ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP3_CNT0)
#define USBFS_SIE_EP3_CNT0_REG   (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP3_CNT0)
#define USBFS_SIE_EP3_CNT1_PTR   ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP3_CNT1)
#define USBFS_SIE_EP3_CNT1_REG   (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP3_CNT1)
#define USBFS_SIE_EP3_CR0_PTR    ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP3_CR0)
#define USBFS_SIE_EP3_CR0_REG    (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP3_CR0)

#define USBFS_SIE_EP4_CNT0_PTR   ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP4_CNT0)
#define USBFS_SIE_EP4_CNT0_REG   (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP4_CNT0)
#define USBFS_SIE_EP4_CNT1_PTR   ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP4_CNT1)
#define USBFS_SIE_EP4_CNT1_REG   (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP4_CNT1)
#define USBFS_SIE_EP4_CR0_PTR    ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP4_CR0)
#define USBFS_SIE_EP4_CR0_REG    (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP4_CR0)

#define USBFS_SIE_EP5_CNT0_PTR   ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP5_CNT0)
#define USBFS_SIE_EP5_CNT0_REG   (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP5_CNT0)
#define USBFS_SIE_EP5_CNT1_PTR   ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP5_CNT1)
#define USBFS_SIE_EP5_CNT1_REG   (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP5_CNT1)
#define USBFS_SIE_EP5_CR0_PTR    ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP5_CR0)
#define USBFS_SIE_EP5_CR0_REG    (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP5_CR0)

#define USBFS_SIE_EP6_CNT0_PTR   ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP6_CNT0)
#define USBFS_SIE_EP6_CNT0_REG   (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP6_CNT0)
#define USBFS_SIE_EP6_CNT1_PTR   ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP6_CNT1)
#define USBFS_SIE_EP6_CNT1_REG   (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP6_CNT1)
#define USBFS_SIE_EP6_CR0_PTR    ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP6_CR0)
#define USBFS_SIE_EP6_CR0_REG    (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP6_CR0)

#define USBFS_SIE_EP7_CNT0_PTR   ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP7_CNT0)
#define USBFS_SIE_EP7_CNT0_REG   (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP7_CNT0)
#define USBFS_SIE_EP7_CNT1_PTR   ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP7_CNT1)
#define USBFS_SIE_EP7_CNT1_REG   (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP7_CNT1)
#define USBFS_SIE_EP7_CR0_PTR    ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP7_CR0)
#define USBFS_SIE_EP7_CR0_REG    (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP7_CR0)

#define USBFS_SIE_EP8_CNT0_PTR   ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP8_CNT0)
#define USBFS_SIE_EP8_CNT0_REG   (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP8_CNT0)
#define USBFS_SIE_EP8_CNT1_PTR   ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP8_CNT1)
#define USBFS_SIE_EP8_CNT1_REG   (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP8_CNT1)
#define USBFS_SIE_EP8_CR0_PTR    ( (reg32 *) USBFS_cy_m0s8_usb__SIE_EP8_CR0)
#define USBFS_SIE_EP8_CR0_REG    (*(reg32 *) USBFS_cy_m0s8_usb__SIE_EP8_CR0)

#define USBFS_SOF0_PTR           ( (reg32 *) USBFS_cy_m0s8_usb__SOF0)
#define USBFS_SOF0_REG           (*(reg32 *) USBFS_cy_m0s8_usb__SOF0)
#define USBFS_SOF1_PTR           ( (reg32 *) USBFS_cy_m0s8_usb__SOF1)
#define USBFS_SOF1_REG           (*(reg32 *) USBFS_cy_m0s8_usb__SOF1)
...
#define USBFS_USBIO_CR0_PTR      ( (reg32 *) USBFS_cy_m0s8_usb__USBIO_CR0)
#define USBFS_USBIO_CR0_REG      (*(reg32 *) USBFS_cy_m0s8_usb__USBIO_CR0)
#define USBFS_USBIO_CR1_PTR      ( (reg32 *) USBFS_cy_m0s8_usb__USBIO_CR1)
#define USBFS_USBIO_CR1_REG      (*(reg32 *) USBFS_cy_m0s8_usb__USBIO_CR1)

#define USBFS_DYN_RECONFIG_PTR   ( (reg32 *) USBFS_cy_m0s8_usb__DYN_RECONFIG)
#define USBFS_DYN_RECONFIG_REG   (*(reg32 *) USBFS_cy_m0s8_usb__DYN_RECONFIG)
    ...
    #define USBFS_ARB_EP16_BASE      (*(volatile USBFS_arb_eps_reg16_struct CYXDATA *) \
                                                (USBFS_cy_m0s8_usb__ARB_RW1_WA16 - sizeof(USBFS_arb_ep_reg16_struct)))
...
#define USBFS_USB_CLK_CSR_CLK_EN     ((uint32) ((uint32) 0x1u << USBFS_USB_CLK_CSR_CLK_EN_POS))
#define USBFS_USB_CLK_ENABLE         (USBFS_USB_CLK_CSR_CLK_EN)

/* USBFS_CR0 */
#define USBFS_CR0_DEVICE_ADDRESS_POS     (0u)
#define USBFS_CR0_ENABLE_POS             (7u)
#define USBFS_CR0_DEVICE_ADDRESS_MASK    ((uint32) ((uint32) 0x7Fu << USBFS_CR0_DEVICE_ADDRESS_POS))
#define USBFS_CR0_ENABLE                 ((uint32) ((uint32) 0x01u << USBFS_CR0_ENABLE_POS))
...
#define USBFS_CR1_REG_ENABLE             ((uint32) ((uint32) 0x1u << USBFS_CR1_REG_ENABLE_POS))
#define USBFS_CR1_ENABLE_LOCK            ((uint32) ((uint32) 0x1u << USBFS_CR1_ENABLE_LOCK_POS))
#define USBFS_CR1_BUS_ACTIVITY           ((uint32) ((uint32) 0x1u << USBFS_CR1_BUS_ACTIVITY_POS))
#define USBFS_CR1_TRIM_OFFSET_MSB        ((uint32) ((uint32) 0x1u << USBFS_CR1_TRIM_OFFSET_MSB_POS))
...
#define USBFS_USBIO_CR1_DM0          ((uint32) ((uint32) 0x1u << USBFS_USBIO_CR1_DM0_POS))
#define USBFS_USBIO_CR1_DP0          ((uint32) ((uint32) 0x1u << USBFS_USBIO_CR1_DP0_POS))
#define USBFS_USBIO_CR1_USBPUEN      ((uint32) ((uint32) 0x1u << USBFS_USBIO_CR1_USBPUEN_POS))
#define USBFS_USBIO_CR1_IOMODE       ((uint32) ((uint32) 0x1u << USBFS_USBIO_CR1_IOMODE_POS))
...
#define USBFS_ARB_EPX_CFG_IN_DATA_RDY        ((uint32) ((uint32) 0x1u << USBFS_ARB_EPX_CFG_IN_DATA_RDY_POS))
#define USBFS_ARB_EPX_CFG_DMA_REQ            ((uint32) ((uint32) 0x1u << USBFS_ARB_EPX_CFG_DMA_REQ_POS))
#define USBFS_ARB_EPX_CFG_CRC_BYPASS         ((uint32) ((uint32) 0x1u << USBFS_ARB_EPX_CFG_CRC_BYPASS_POS))
#define USBFS_ARB_EPX_CFG_RESET              ((uint32) ((uint32) 0x1u << USBFS_ARB_EPX_CFG_RESET_POS))
...
#define USBFS_ARB_EPX_INT_IN_BUF_FULL        ((uint32) ((uint32) 0x1u << USBFS_ARB_EPX_INT_IN_BUF_FULL_POS))
#define USBFS_ARB_EPX_INT_DMA_GNT            ((uint32) ((uint32) 0x1u << USBFS_ARB_EPX_INT_DMA_GNT_POS))
#define USBFS_ARB_EPX_INT_BUF_OVER           ((uint32) ((uint32) 0x1u << USBFS_ARB_EPX_INT_BUF_OVER_POS))
#define USBFS_ARB_EPX_INT_BUF_UNDER          ((uint32) ((uint32) 0x1u << USBFS_ARB_EPX_INT_BUF_UNDER_POS))
#define USBFS_ARB_EPX_INT_ERR_INT            ((uint32) ((uint32) 0x1u << USBFS_ARB_EPX_INT_ERR_INT_POS))

#if (CY_PSOC4)
#define USBFS_ARB_EPX_INT_DMA_TERMIN_POS     (5u)
#define USBFS_ARB_EPX_INT_DMA_TERMIN         ((uint32) ((uint32) 0x1u << USBFS_ARB_EPX_INT_DMA_TERMIN_POS))
#endif /* (CY_PSOC4) */
...
#define USBFS_ARB_CFG_AUTO_MEM       ((uint32) ((uint32) 0x1u << USBFS_ARB_CFG_AUTO_MEM_POS))
#define USBFS_ARB_CFG_DMA_CFG_MASK   ((uint32) ((uint32) 0x3u << USBFS_ARB_CFG_DMA_CFG_POS))
#define USBFS_ARB_CFG_DMA_CFG_NONE   ((uint32) ((uint32) 0x0u << USBFS_ARB_CFG_DMA_CFG_POS))
#define USBFS_ARB_CFG_DMA_CFG_MANUAL ((uint32) ((uint32) 0x1u << USBFS_ARB_CFG_DMA_CFG_POS))
#define USBFS_ARB_CFG_DMA_CFG_AUTO   ((uint32) ((uint32) 0x2u << USBFS_ARB_CFG_DMA_CFG_POS))
#define USBFS_ARB_CFG_CFG_CMP        ((uint32) ((uint32) 0x1u << USBFS_ARB_CFG_CFG_CMP_POS))
...
#define USBFS_DYN_RECONFIG_ENABLE        ((uint32) ((uint32) 0x1u << USBFS_DYN_RECONFIG_ENABLE_POS))
#define USBFS_DYN_RECONFIG_EPNO_MASK     ((uint32) ((uint32) 0x7u << USBFS_DYN_RECONFIG_EPNO_POS))
#define USBFS_DYN_RECONFIG_RDY_STS       ((uint32) ((uint32) 0x1u << USBFS_DYN_RECONFIG_RDY_STS_POS))
...
#define USBFS_ARB_INT_EP1_INTR              ((uint32) ((uint32) 0x1u << USBFS_ARB_INT_EP1_INTR_POS))
#define USBFS_ARB_INT_EP2_INTR              ((uint32) ((uint32) 0x1u << USBFS_ARB_INT_EP2_INTR_POS))
#define USBFS_ARB_INT_EP3_INTR              ((uint32) ((uint32) 0x1u << USBFS_ARB_INT_EP3_INTR_POS))
#define USBFS_ARB_INT_EP4_INTR              ((uint32) ((uint32) 0x1u << USBFS_ARB_INT_EP4_INTR_POS))
#define USBFS_ARB_INT_EP5_INTR              ((uint32) ((uint32) 0x1u << USBFS_ARB_INT_EP5_INTR_POS))
#define USBFS_ARB_INT_EP6_INTR              ((uint32) ((uint32) 0x1u << USBFS_ARB_INT_EP6_INTR_POS))
#define USBFS_ARB_INT_EP7_INTR              ((uint32) ((uint32) 0x1u << USBFS_ARB_INT_EP7_INTR_POS))
#define USBFS_ARB_INT_EP8_INTR              ((uint32) ((uint32) 0x1u << USBFS_ARB_INT_EP8_INTR_POS))
...
#define USBFS_SIE_INT_EP1_INTR              ((uint32) ((uint32) 0x01u << USBFS_SIE_INT_EP1_INTR_POS))
#define USBFS_SIE_INT_EP2_INTR              ((uint32) ((uint32) 0x01u << USBFS_SIE_INT_EP2_INTR_POS))
#define USBFS_SIE_INT_EP3_INTR              ((uint32) ((uint32) 0x01u << USBFS_SIE_INT_EP3_INTR_POS))
#define USBFS_SIE_INT_EP4_INTR              ((uint32) ((uint32) 0x01u << USBFS_SIE_INT_EP4_INTR_POS))
#define USBFS_SIE_INT_EP5_INTR              ((uint32) ((uint32) 0x01u << USBFS_SIE_INT_EP5_INTR_POS))
#define USBFS_SIE_INT_EP6_INTR              ((uint32) ((uint32) 0x01u << USBFS_SIE_INT_EP6_INTR_POS))
#define USBFS_SIE_INT_EP7_INTR              ((uint32) ((uint32) 0x01u << USBFS_SIE_INT_EP7_INTR_POS))
#define USBFS_SIE_INT_EP8_INTR              ((uint32) ((uint32) 0x01u << USBFS_SIE_INT_EP8_INTR_POS))
...
#define USBFS_DEFAULT_ARB_INT_EN \
        ((uint32) ((uint32) USBFS_DMA1_ACTIVE << USBFS_ARB_INT_EP1_INTR_POS) | \
         (uint32) ((uint32) USBFS_DMA2_ACTIVE << USBFS_ARB_INT_EP2_INTR_POS) | \
         (uint32) ((uint32) USBFS_DMA3_ACTIVE << USBFS_ARB_INT_EP3_INTR_POS) | \
         (uint32) ((uint32) USBFS_DMA4_ACTIVE << USBFS_ARB_INT_EP4_INTR_POS) | \
         (uint32) ((uint32) USBFS_DMA5_ACTIVE << USBFS_ARB_INT_EP5_INTR_POS) | \
         (uint32) ((uint32) USBFS_DMA6_ACTIVE << USBFS_ARB_INT_EP6_INTR_POS) | \
         (uint32) ((uint32) USBFS_DMA7_ACTIVE << USBFS_ARB_INT_EP7_INTR_POS) | \
         (uint32) ((uint32) USBFS_DMA8_ACTIVE << USBFS_ARB_INT_EP8_INTR_POS))
...
#define USBFS_DM_INP_DIS_PTR     ( (reg32 *) USBFS_Dm__INP_DIS)
#define USBFS_DM_INP_DIS_REG     (*(reg32 *) USBFS_Dm__INP_DIS)
#define USBFS_DP_INP_DIS_PTR     ( (reg32 *) USBFS_Dp__INP_DIS)
#define USBFS_DP_INP_DIS_REG     (*(reg32 *) USBFS_Dp__INP_DIS)
#define USBFS_DP_INTSTAT_PTR     ( (reg32 *) USBFS_Dp__INTSTAT)
#define USBFS_DP_INTSTAT_REG     (*(reg32 *) USBFS_Dp__INTSTAT)
