...
void QuadDec_2_Enable(void)
{
    ...
    #if (QuadDec_2__QUAD == QuadDec_2_CONFIG)
        #if (0u != QuadDec_2_QUAD_AUTO_START)
            QuadDec_2_TriggerCommand(QuadDec_2_MASK, QuadDec_2_CMD_RELOAD);
        #endif /* (0u != QuadDec_2_QUAD_AUTO_START) */
    #endif  /* (QuadDec_2__QUAD == QuadDec_2_CONFIG) */
}
...
*   Values:
*     - QuadDec_2_CMD_CAPTURE    - Trigger Capture/Switch command
*     - QuadDec_2_CMD_RELOAD     - Trigger Reload/Index command
*     - QuadDec_2_CMD_STOP       - Trigger Stop/Kill command
*     - QuadDec_2_CMD_START      - Trigger Start/phiB command
*
* Return:
*  None
*
