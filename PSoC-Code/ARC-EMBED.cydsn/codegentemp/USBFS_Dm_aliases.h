...
#define USBFS_Dm_0_PS		(USBFS_Dm__0__PS)
#define USBFS_Dm_0_PC		(USBFS_Dm__0__PC)
#define USBFS_Dm_0_DR		(USBFS_Dm__0__DR)
#define USBFS_Dm_0_SHIFT	(USBFS_Dm__0__SHIFT)
#define USBFS_Dm_0_INTR	((uint16)((uint16)0x0003u << (USBFS_Dm__0__SHIFT*2u)))
