...
#include "cyapicallbacks.h"
    ...
    *******************************************************************************/
    CY_ISR_PROTO(EZI2C_1_EZI2C_STRETCH_ISR)
    {
    ...
    #ifdef EZI2C_1_EZI2C_STRETCH_ISR_ENTRY_CALLBACK
        EZI2C_1_EZI2C_STRETCH_ISR_EntryCallback();
    #endif /* EZI2C_1_EZI2C_STRETCH_ISR_ENTRY_CALLBACK */
        ...
        static uint16 EZI2C_1_bufSizeBuf;           /* Size of buffer in bytes             */
        ...
        else
        {
                ...
                else if (0u != (EZI2C_1_I2C_CTRL_REG & EZI2C_1_I2C_CTRL_S_READY_DATA_ACK))
                {
                    ...
                    */
                    ...
                    /* Continue transfer or disable INTR_RX_FULL to catch completion event. */
                    {
                        ...
                        locBufSize -= (uint16) EZI2C_1_EZI2C_FIFO_SIZE;
                        ...
                        else
                        {
                            ...
                            fifoIndex   = EZI2C_1_EZI2C_FIFO_SIZE;
                            endTransfer = EZI2C_1_EZI2C_CONTINUE_TRANSFER;
                        }
                    }
            ...
            */
            if(0u != (EZI2C_1_GetInterruptCause() & EZI2C_1_INTR_CAUSE_TX))
            {
                ...
                while(EZI2C_1_EZI2C_FIFO_SIZE != EZI2C_1_GET_TX_FIFO_ENTRIES);
    ...
    #ifdef EZI2C_1_EZI2C_STRETCH_ISR_EXIT_CALLBACK
        EZI2C_1_EZI2C_STRETCH_ISR_ExitCallback();
    #endif /* EZI2C_1_EZI2C_STRETCH_ISR_EXIT_CALLBACK */
    ...
    *******************************************************************************/
    CY_ISR_PROTO(EZI2C_1_EZI2C_NO_STRETCH_ISR)
    {
    ...
    #ifdef EZI2C_1_EZI2C_NO_STRETCH_ISR_ENTRY_CALLBACK
        EZI2C_1_EZI2C_NO_STRETCH_ISR_EntryCallback();
    #endif /* EZI2C_1_EZI2C_NO_STRETCH_ISR_ENTRY_CALLBACK */
        ...
        */
        ...
        else
        {
            ...
            *  until used entries are less than EZI2C_1_TX_LOAD_SIZE. If index reaches end of the
    ...
    #ifdef EZI2C_1_EZI2C_NO_STRETCH_ISR_EXIT_CALLBACK
        EZI2C_1_EZI2C_NO_STRETCH_ISR_ExitCallback();
    #endif /* EZI2C_1_EZI2C_NO_STRETCH_ISR_EXIT_CALLBACK */
