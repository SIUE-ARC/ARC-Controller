...
#define EZI2C_1_REMOVE_CTS_SCLK_PIN      (1u)
#define EZI2C_1_REMOVE_RTS_SS0_PIN      (1u)
...
#define EZI2C_1_CTS_SCLK_PIN     (0u == EZI2C_1_REMOVE_CTS_SCLK_PIN)
#define EZI2C_1_RTS_SS0_PIN     (0u == EZI2C_1_REMOVE_RTS_SS0_PIN)
...
****************************************/
    ...
    #include "EZI2C_1_uart_cts_spi_sclk.h"
#endif /* (EZI2C_1_CTS_SCLK) */

#if (EZI2C_1_RTS_SS0_PIN)
    #include "EZI2C_1_uart_rts_spi_ss0.h"
...
***************************************/
    ...
    #define EZI2C_1_RX_SCL_MOSI_HSIOM_SEL_GPIO  (EZI2C_1_uart_rx_i2c_scl_spi_mosi__0__HSIOM_GPIO)
    #define EZI2C_1_RX_SCL_MOSI_HSIOM_SEL_I2C   (EZI2C_1_uart_rx_i2c_scl_spi_mosi__0__HSIOM_I2C)
    #define EZI2C_1_RX_SCL_MOSI_HSIOM_SEL_SPI   (EZI2C_1_uart_rx_i2c_scl_spi_mosi__0__HSIOM_SPI)
    #define EZI2C_1_RX_SCL_MOSI_HSIOM_SEL_UART  (EZI2C_1_uart_rx_i2c_scl_spi_mosi__0__HSIOM_UART)
    
#elif (EZI2C_1_RX_WAKE_SCL_MOSI_PIN)
    #define EZI2C_1_RX_WAKE_SCL_MOSI_HSIOM_REG   (*(reg32 *) EZI2C_1_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define EZI2C_1_RX_WAKE_SCL_MOSI_HSIOM_PTR   ( (reg32 *) EZI2C_1_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    
    #define EZI2C_1_RX_WAKE_SCL_MOSI_HSIOM_MASK      (EZI2C_1_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_MASK)
    #define EZI2C_1_RX_WAKE_SCL_MOSI_HSIOM_POS       (EZI2C_1_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_SHIFT)
    #define EZI2C_1_RX_WAKE_SCL_MOSI_HSIOM_SEL_GPIO  (EZI2C_1_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_GPIO)
    #define EZI2C_1_RX_WAKE_SCL_MOSI_HSIOM_SEL_I2C   (EZI2C_1_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_I2C)
    #define EZI2C_1_RX_WAKE_SCL_MOSI_HSIOM_SEL_SPI   (EZI2C_1_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_SPI)
    #define EZI2C_1_RX_WAKE_SCL_MOSI_HSIOM_SEL_UART  (EZI2C_1_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_UART)    
   
    #define EZI2C_1_RX_WAKE_SCL_MOSI_INTCFG_REG (*(reg32 *) EZI2C_1_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define EZI2C_1_RX_WAKE_SCL_MOSI_INTCFG_PTR ( (reg32 *) EZI2C_1_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define EZI2C_1_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS  (EZI2C_1_uart_rx_wake_i2c_scl_spi_mosi__SHIFT)
    #define EZI2C_1_RX_WAKE_SCL_MOSI_INTCFG_TYPE_MASK ((uint32) EZI2C_1_INTCFG_TYPE_MASK << \
                                                                           EZI2C_1_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS)
#else
    /* None of pins EZI2C_1_RX_SCL_MOSI_PIN or EZI2C_1_RX_WAKE_SCL_MOSI_PIN present.*/
    ...
    #define EZI2C_1_TX_SDA_MISO_HSIOM_SEL_GPIO  (EZI2C_1_uart_tx_i2c_sda_spi_miso__0__HSIOM_GPIO)
    #define EZI2C_1_TX_SDA_MISO_HSIOM_SEL_I2C   (EZI2C_1_uart_tx_i2c_sda_spi_miso__0__HSIOM_I2C)
    #define EZI2C_1_TX_SDA_MISO_HSIOM_SEL_SPI   (EZI2C_1_uart_tx_i2c_sda_spi_miso__0__HSIOM_SPI)
    #define EZI2C_1_TX_SDA_MISO_HSIOM_SEL_UART  (EZI2C_1_uart_tx_i2c_sda_spi_miso__0__HSIOM_UART)
#endif /* (EZI2C_1_TX_SDA_MISO_PIN) */

#if (EZI2C_1_CTS_SCLK_PIN)
    #define EZI2C_1_CTS_SCLK_HSIOM_REG   (*(reg32 *) EZI2C_1_uart_cts_spi_sclk__0__HSIOM)
    #define EZI2C_1_CTS_SCLK_HSIOM_PTR   ( (reg32 *) EZI2C_1_uart_cts_spi_sclk__0__HSIOM)
    
    #define EZI2C_1_CTS_SCLK_HSIOM_MASK      (EZI2C_1_uart_cts_spi_sclk__0__HSIOM_MASK)
    #define EZI2C_1_CTS_SCLK_HSIOM_POS       (EZI2C_1_uart_cts_spi_sclk__0__HSIOM_SHIFT)
    #define EZI2C_1_CTS_SCLK_HSIOM_SEL_GPIO  (EZI2C_1_uart_cts_spi_sclk__0__HSIOM_GPIO)
    #define EZI2C_1_CTS_SCLK_HSIOM_SEL_I2C   (EZI2C_1_uart_cts_spi_sclk__0__HSIOM_I2C)
    #define EZI2C_1_CTS_SCLK_HSIOM_SEL_SPI   (EZI2C_1_uart_cts_spi_sclk__0__HSIOM_SPI)
    #define EZI2C_1_CTS_SCLK_HSIOM_SEL_UART  (EZI2C_1_uart_cts_spi_sclk__0__HSIOM_UART)
#endif /* (EZI2C_1_CTS_SCLK_PIN) */

#if (EZI2C_1_RTS_SS0_PIN)
    #define EZI2C_1_RTS_SS0_HSIOM_REG   (*(reg32 *) EZI2C_1_uart_rts_spi_ss0__0__HSIOM)
    #define EZI2C_1_RTS_SS0_HSIOM_PTR   ( (reg32 *) EZI2C_1_uart_rts_spi_ss0__0__HSIOM)
    
    #define EZI2C_1_RTS_SS0_HSIOM_MASK      (EZI2C_1_uart_rts_spi_ss0__0__HSIOM_MASK)
    #define EZI2C_1_RTS_SS0_HSIOM_POS       (EZI2C_1_uart_rts_spi_ss0__0__HSIOM_SHIFT)
    #define EZI2C_1_RTS_SS0_HSIOM_SEL_GPIO  (EZI2C_1_uart_rts_spi_ss0__0__HSIOM_GPIO)
    #define EZI2C_1_RTS_SS0_HSIOM_SEL_I2C   (EZI2C_1_uart_rts_spi_ss0__0__HSIOM_I2C)
    #define EZI2C_1_RTS_SS0_HSIOM_SEL_SPI   (EZI2C_1_uart_rts_spi_ss0__0__HSIOM_SPI)
#if !(EZI2C_1_CY_SCBIP_V0 || EZI2C_1_CY_SCBIP_V1)
    #define EZI2C_1_RTS_SS0_HSIOM_SEL_UART  (EZI2C_1_uart_rts_spi_ss0__0__HSIOM_UART)
    ...
    #define EZI2C_1_SS1_HSIOM_SEL_GPIO (EZI2C_1_spi_ss1__0__HSIOM_GPIO)
    #define EZI2C_1_SS1_HSIOM_SEL_I2C  (EZI2C_1_spi_ss1__0__HSIOM_I2C)
    #define EZI2C_1_SS1_HSIOM_SEL_SPI  (EZI2C_1_spi_ss1__0__HSIOM_SPI)
#endif /* (EZI2C_1_SS1_PIN) */
    ...
    #define EZI2C_1_SS2_HSIOM_SEL_GPIO (EZI2C_1_spi_ss2__0__HSIOM_GPIO)
    #define EZI2C_1_SS2_HSIOM_SEL_I2C  (EZI2C_1_spi_ss2__0__HSIOM_I2C)
    #define EZI2C_1_SS2_HSIOM_SEL_SPI  (EZI2C_1_spi_ss2__0__HSIOM_SPI)
#endif /* (EZI2C_1_SS2_PIN) */
    ...
    #define EZI2C_1_SS3_HSIOM_SEL_GPIO (EZI2C_1_spi_ss3__0__HSIOM_GPIO)
    #define EZI2C_1_SS3_HSIOM_SEL_I2C  (EZI2C_1_spi_ss3__0__HSIOM_I2C)
    #define EZI2C_1_SS3_HSIOM_SEL_SPI  (EZI2C_1_spi_ss3__0__HSIOM_SPI)
#endif /* (EZI2C_1_SS3_PIN) */
    ...
    #define EZI2C_1_SCL_HSIOM_SEL_GPIO (EZI2C_1_sda__0__HSIOM_GPIO)
    #define EZI2C_1_SCL_HSIOM_SEL_I2C  (EZI2C_1_sda__0__HSIOM_I2C)
    ...
    #define EZI2C_1_SDA_HSIOM_SEL_GPIO (EZI2C_1_sda__0__HSIOM_GPIO)
    #define EZI2C_1_SDA_HSIOM_SEL_I2C  (EZI2C_1_sda__0__HSIOM_I2C)
#endif /* (EZI2C_1_I2C_PINS) */

#if (EZI2C_1_SPI_SLAVE_PINS)
    #define EZI2C_1_SCLK_S_HSIOM_REG   (*(reg32 *) EZI2C_1_sclk_s__0__HSIOM)
    #define EZI2C_1_SCLK_S_HSIOM_PTR   ( (reg32 *) EZI2C_1_sclk_s__0__HSIOM)
    
    #define EZI2C_1_SCLK_S_HSIOM_MASK      (EZI2C_1_sclk_s__0__HSIOM_MASK)
    #define EZI2C_1_SCLK_S_HSIOM_POS       (EZI2C_1_sclk_s__0__HSIOM_SHIFT)
    #define EZI2C_1_SCLK_S_HSIOM_SEL_GPIO  (EZI2C_1_sclk_s__0__HSIOM_GPIO)
    #define EZI2C_1_SCLK_S_HSIOM_SEL_SPI   (EZI2C_1_sclk_s__0__HSIOM_SPI)
    
    #define EZI2C_1_SS0_S_HSIOM_REG    (*(reg32 *) EZI2C_1_ss0_s__0__HSIOM)
    #define EZI2C_1_SS0_S_HSIOM_PTR    ( (reg32 *) EZI2C_1_ss0_s__0__HSIOM)
    
    #define EZI2C_1_SS0_S_HSIOM_MASK       (EZI2C_1_ss0_s__0__HSIOM_MASK)
    #define EZI2C_1_SS0_S_HSIOM_POS        (EZI2C_1_ss0_s__0__HSIOM_SHIFT)
    #define EZI2C_1_SS0_S_HSIOM_SEL_GPIO   (EZI2C_1_ss0_s__0__HSIOM_GPIO)  
    #define EZI2C_1_SS0_S_HSIOM_SEL_SPI    (EZI2C_1_ss0_s__0__HSIOM_SPI)
#endif /* (EZI2C_1_SPI_SLAVE_PINS) */

#if (EZI2C_1_SPI_SLAVE_MOSI_PIN)
    #define EZI2C_1_MOSI_S_HSIOM_REG   (*(reg32 *) EZI2C_1_mosi_s__0__HSIOM)
    #define EZI2C_1_MOSI_S_HSIOM_PTR   ( (reg32 *) EZI2C_1_mosi_s__0__HSIOM)
    
    #define EZI2C_1_MOSI_S_HSIOM_MASK      (EZI2C_1_mosi_s__0__HSIOM_MASK)
    #define EZI2C_1_MOSI_S_HSIOM_POS       (EZI2C_1_mosi_s__0__HSIOM_SHIFT)
    #define EZI2C_1_MOSI_S_HSIOM_SEL_GPIO  (EZI2C_1_mosi_s__0__HSIOM_GPIO)
    #define EZI2C_1_MOSI_S_HSIOM_SEL_SPI   (EZI2C_1_mosi_s__0__HSIOM_SPI)
#endif /* (EZI2C_1_SPI_SLAVE_MOSI_PIN) */

#if (EZI2C_1_SPI_SLAVE_MISO_PIN)
    #define EZI2C_1_MISO_S_HSIOM_REG   (*(reg32 *) EZI2C_1_miso_s__0__HSIOM)
    #define EZI2C_1_MISO_S_HSIOM_PTR   ( (reg32 *) EZI2C_1_miso_s__0__HSIOM)
    
    #define EZI2C_1_MISO_S_HSIOM_MASK      (EZI2C_1_miso_s__0__HSIOM_MASK)
    #define EZI2C_1_MISO_S_HSIOM_POS       (EZI2C_1_miso_s__0__HSIOM_SHIFT)
    #define EZI2C_1_MISO_S_HSIOM_SEL_GPIO  (EZI2C_1_miso_s__0__HSIOM_GPIO)
    #define EZI2C_1_MISO_S_HSIOM_SEL_SPI   (EZI2C_1_miso_s__0__HSIOM_SPI)
#endif /* (EZI2C_1_SPI_SLAVE_MISO_PIN) */

#if (EZI2C_1_SPI_MASTER_MISO_PIN)
    #define EZI2C_1_MISO_M_HSIOM_REG   (*(reg32 *) EZI2C_1_miso_m__0__HSIOM)
    #define EZI2C_1_MISO_M_HSIOM_PTR   ( (reg32 *) EZI2C_1_miso_m__0__HSIOM)
    
    #define EZI2C_1_MISO_M_HSIOM_MASK      (EZI2C_1_miso_m__0__HSIOM_MASK)
    #define EZI2C_1_MISO_M_HSIOM_POS       (EZI2C_1_miso_m__0__HSIOM_SHIFT)
    #define EZI2C_1_MISO_M_HSIOM_SEL_GPIO  (EZI2C_1_miso_m__0__HSIOM_GPIO)
    #define EZI2C_1_MISO_M_HSIOM_SEL_SPI   (EZI2C_1_miso_m__0__HSIOM_SPI)
#endif /* (EZI2C_1_SPI_MASTER_MISO_PIN) */

#if (EZI2C_1_SPI_MASTER_MOSI_PIN)
    #define EZI2C_1_MOSI_M_HSIOM_REG   (*(reg32 *) EZI2C_1_mosi_m__0__HSIOM)
    #define EZI2C_1_MOSI_M_HSIOM_PTR   ( (reg32 *) EZI2C_1_mosi_m__0__HSIOM)
    
    #define EZI2C_1_MOSI_M_HSIOM_MASK      (EZI2C_1_mosi_m__0__HSIOM_MASK)
    #define EZI2C_1_MOSI_M_HSIOM_POS       (EZI2C_1_mosi_m__0__HSIOM_SHIFT)
    #define EZI2C_1_MOSI_M_HSIOM_SEL_GPIO  (EZI2C_1_mosi_m__0__HSIOM_GPIO)
    #define EZI2C_1_MOSI_M_HSIOM_SEL_SPI   (EZI2C_1_mosi_m__0__HSIOM_SPI)
#endif /* (EZI2C_1_SPI_MASTER_MOSI_PIN) */
    ...
    #define EZI2C_1_SCLK_M_HSIOM_SEL_GPIO  (EZI2C_1_sclk_m__0__HSIOM_GPIO)
    #define EZI2C_1_SCLK_M_HSIOM_SEL_SPI   (EZI2C_1_sclk_m__0__HSIOM_SPI)
#endif /* (EZI2C_1_SPI_MASTER_SCLK_PIN) */
    ...
    #define EZI2C_1_SS0_M_HSIOM_SEL_GPIO   (EZI2C_1_ss0_m__0__HSIOM_GPIO)
    #define EZI2C_1_SS0_M_HSIOM_SEL_SPI    (EZI2C_1_ss0_m__0__HSIOM_SPI)
#endif /* (EZI2C_1_SPI_MASTER_SS0_PIN) */
    ...
    #define EZI2C_1_SS1_M_HSIOM_SEL_GPIO   (EZI2C_1_ss1_m__0__HSIOM_GPIO)
    #define EZI2C_1_SS1_M_HSIOM_SEL_SPI    (EZI2C_1_ss1_m__0__HSIOM_SPI)
#endif /* (EZI2C_1_SPI_MASTER_SS1_PIN) */
    ...
    #define EZI2C_1_SS2_M_HSIOM_SEL_GPIO   (EZI2C_1_ss2_m__0__HSIOM_GPIO)
    #define EZI2C_1_SS2_M_HSIOM_SEL_SPI    (EZI2C_1_ss2_m__0__HSIOM_SPI)
#endif /* (EZI2C_1_SPI_MASTER_SS2_PIN) */
    ...
    #define EZI2C_1_SS3_M_HSIOM_SEL_GPIO  (EZI2C_1_ss3_m__0__HSIOM_GPIO)
    #define EZI2C_1_SS3_M_HSIOM_SEL_SPI   (EZI2C_1_ss3_m__0__HSIOM_SPI)
#endif /* (EZI2C_1_SPI_MASTER_SS3_PIN) */

#if (EZI2C_1_UART_RX_PIN)
    #define EZI2C_1_RX_HSIOM_REG   (*(reg32 *) EZI2C_1_rx__0__HSIOM)
    #define EZI2C_1_RX_HSIOM_PTR   ( (reg32 *) EZI2C_1_rx__0__HSIOM)
    
    #define EZI2C_1_RX_HSIOM_MASK      (EZI2C_1_rx__0__HSIOM_MASK)
    #define EZI2C_1_RX_HSIOM_POS       (EZI2C_1_rx__0__HSIOM_SHIFT)
    #define EZI2C_1_RX_HSIOM_SEL_GPIO  (EZI2C_1_rx__0__HSIOM_GPIO)
    #define EZI2C_1_RX_HSIOM_SEL_UART  (EZI2C_1_rx__0__HSIOM_UART)
#endif /* (EZI2C_1_UART_RX_PIN) */

#if (EZI2C_1_UART_RX_WAKE_PIN)
    #define EZI2C_1_RX_WAKE_HSIOM_REG   (*(reg32 *) EZI2C_1_rx_wake__0__HSIOM)
    #define EZI2C_1_RX_WAKE_HSIOM_PTR   ( (reg32 *) EZI2C_1_rx_wake__0__HSIOM)
    
    #define EZI2C_1_RX_WAKE_HSIOM_MASK      (EZI2C_1_rx_wake__0__HSIOM_MASK)
    #define EZI2C_1_RX_WAKE_HSIOM_POS       (EZI2C_1_rx_wake__0__HSIOM_SHIFT)
    #define EZI2C_1_RX_WAKE_HSIOM_SEL_GPIO  (EZI2C_1_rx_wake__0__HSIOM_GPIO)
    #define EZI2C_1_RX_WAKE_HSIOM_SEL_UART  (EZI2C_1_rx_wake__0__HSIOM_UART)
#endif /* (EZI2C_1_UART_WAKE_RX_PIN) */

#if (EZI2C_1_UART_CTS_PIN)
    #define EZI2C_1_CTS_HSIOM_REG   (*(reg32 *) EZI2C_1_cts__0__HSIOM)
    #define EZI2C_1_CTS_HSIOM_PTR   ( (reg32 *) EZI2C_1_cts__0__HSIOM)
    
    #define EZI2C_1_CTS_HSIOM_MASK      (EZI2C_1_cts__0__HSIOM_MASK)
    #define EZI2C_1_CTS_HSIOM_POS       (EZI2C_1_cts__0__HSIOM_SHIFT)
    #define EZI2C_1_CTS_HSIOM_SEL_GPIO  (EZI2C_1_cts__0__HSIOM_GPIO)
    #define EZI2C_1_CTS_HSIOM_SEL_UART  (EZI2C_1_cts__0__HSIOM_UART)
#endif /* (EZI2C_1_UART_CTS_PIN) */

#if (EZI2C_1_UART_TX_PIN)
    #define EZI2C_1_TX_HSIOM_REG   (*(reg32 *) EZI2C_1_tx__0__HSIOM)
    #define EZI2C_1_TX_HSIOM_PTR   ( (reg32 *) EZI2C_1_tx__0__HSIOM)
    
    #define EZI2C_1_TX_HSIOM_MASK      (EZI2C_1_tx__0__HSIOM_MASK)
    #define EZI2C_1_TX_HSIOM_POS       (EZI2C_1_tx__0__HSIOM_SHIFT)
    #define EZI2C_1_TX_HSIOM_SEL_GPIO  (EZI2C_1_tx__0__HSIOM_GPIO)
    #define EZI2C_1_TX_HSIOM_SEL_UART  (EZI2C_1_tx__0__HSIOM_UART)
#endif /* (EZI2C_1_UART_TX_PIN) */

#if (EZI2C_1_UART_RX_TX_PIN)
    #define EZI2C_1_RX_TX_HSIOM_REG   (*(reg32 *) EZI2C_1_rx_tx__0__HSIOM)
    #define EZI2C_1_RX_TX_HSIOM_PTR   ( (reg32 *) EZI2C_1_rx_tx__0__HSIOM)
    
    #define EZI2C_1_RX_TX_HSIOM_MASK      (EZI2C_1_rx_tx__0__HSIOM_MASK)
    #define EZI2C_1_RX_TX_HSIOM_POS       (EZI2C_1_rx_tx__0__HSIOM_SHIFT)
    #define EZI2C_1_RX_TX_HSIOM_SEL_GPIO  (EZI2C_1_rx_tx__0__HSIOM_GPIO)
    #define EZI2C_1_RX_TX_HSIOM_SEL_UART  (EZI2C_1_rx_tx__0__HSIOM_UART)
#endif /* (EZI2C_1_UART_RX_TX_PIN) */
    ...
    #define EZI2C_1_RTS_HSIOM_SEL_GPIO (EZI2C_1_rts__0__HSIOM_GPIO)
    #define EZI2C_1_RTS_HSIOM_SEL_UART (EZI2C_1_rts__0__HSIOM_UART)    
#endif /* (EZI2C_1_UART_RTS_PIN) */
...
/* The HSIOM values provided below are valid only for EZI2C_1_CY_SCBIP_V0 
* and EZI2C_1_CY_SCBIP_V1. It is not recommended to use them for 
* EZI2C_1_CY_SCBIP_V2. Use pin name specific HSIOM constants provided 
...
#define EZI2C_1_CTS_SCLK_PIN_INDEX       (2u)
#define EZI2C_1_RTS_SS0_PIN_INDEX       (3u)
...
#define EZI2C_1_CTS_SCLK_PIN_MASK     ((uint32) 0x01u << EZI2C_1_CTS_SCLK_PIN_INDEX)
#define EZI2C_1_RTS_SS0_PIN_MASK     ((uint32) 0x01u << EZI2C_1_RTS_SS0_PIN_INDEX)
...
#if (EZI2C_1_RTS_SS0_PIN)
    #define EZI2C_1_CHECK_RTS_SS0_PIN_USED \
                (EZI2C_1_PIN_DM_ALG_HIZ != \
                    EZI2C_1_GET_P4_PIN_DM(EZI2C_1_uart_rts_spi_ss0_PC, \
                                                   EZI2C_1_uart_rts_spi_ss0_SHIFT))
#endif /* (EZI2C_1_RTS_SS0_PIN) */
...
#else
    #define EZI2C_1_SET_I2C_SCL_DR(val)        do{ /* Does nothing */ }while(0)
    #define EZI2C_1_SET_I2C_SCL_HSIOM_SEL(sel) do{ /* Does nothing */ }while(0)
...
#if (EZI2C_1_RX_SCL_MOSI_PIN)
    #define EZI2C_1_CLEAR_UART_RX_WAKE_INTR        do{ /* Does nothing */ }while(0)
    
#elif (EZI2C_1_RX_WAKE_SCL_MOSI_PIN)
    #define EZI2C_1_CLEAR_UART_RX_WAKE_INTR \
            do{                                      \
                (void) EZI2C_1_uart_rx_wake_i2c_scl_spi_mosi_ClearInterrupt(); \
            }while(0)

#elif(EZI2C_1_UART_RX_WAKE_PIN)
    #define EZI2C_1_CLEAR_UART_RX_WAKE_INTR \
            do{                                      \
                (void) EZI2C_1_rx_wake_ClearInterrupt(); \
            }while(0)
#else
#endif /* (EZI2C_1_RX_SCL_MOSI_PIN) */
...
#define EZI2C_1_REMOVE_SCLK_PIN                EZI2C_1_REMOVE_CTS_SCLK_PIN
#endif /* EZI2C_1_REMOVE_SCLK_PIN */
#ifndef EZI2C_1_REMOVE_SS0_PIN
#define EZI2C_1_REMOVE_SS0_PIN                 EZI2C_1_REMOVE_RTS_SS0_PIN
...
#define EZI2C_1_SCLK_PIN               EZI2C_1_CTS_SCLK_PIN
#endif /* EZI2C_1_SCLK_PIN */
#ifndef EZI2C_1_SS0_PIN
#define EZI2C_1_SS0_PIN                EZI2C_1_RTS_SS0_PIN
    ...
    #define EZI2C_1_SCLK_HSIOM_REG     EZI2C_1_CTS_SCLK_HSIOM_REG
    #define EZI2C_1_SCLK_HSIOM_PTR     EZI2C_1_CTS_SCLK_HSIOM_PTR
    #define EZI2C_1_SCLK_HSIOM_MASK    EZI2C_1_CTS_SCLK_HSIOM_MASK
    #define EZI2C_1_SCLK_HSIOM_POS     EZI2C_1_CTS_SCLK_HSIOM_POS
    #endif /* EZI2C_1_SCLK_HSIOM_REG */
#endif /* (EZI2C_1_SCLK_PIN) */

#if (EZI2C_1_SS0_PIN)
    #ifndef EZI2C_1_SS0_HSIOM_REG
    #define EZI2C_1_SS0_HSIOM_REG      EZI2C_1_RTS_SS0_HSIOM_REG
    #define EZI2C_1_SS0_HSIOM_PTR      EZI2C_1_RTS_SS0_HSIOM_PTR
    #define EZI2C_1_SS0_HSIOM_MASK     EZI2C_1_RTS_SS0_HSIOM_MASK
    #define EZI2C_1_SS0_HSIOM_POS      EZI2C_1_RTS_SS0_HSIOM_POS
...
#define EZI2C_1_SCLK_PIN_INDEX             EZI2C_1_CTS_SCLK_PIN_INDEX
#endif /* EZI2C_1_SCLK_PIN_INDEX */
#ifndef EZI2C_1_SS0_PIN_INDEX
#define EZI2C_1_SS0_PIN_INDEX              EZI2C_1_RTS_SS0_PIN_INDEX
...
#define EZI2C_1_SCLK_PIN_MASK             EZI2C_1_CTS_SCLK_PIN_MASK
#endif /* EZI2C_1_SCLK_PIN_MASK */
#ifndef EZI2C_1_SS0_PIN_MASK
#define EZI2C_1_SS0_PIN_MASK              EZI2C_1_RTS_SS0_PIN_MASK
